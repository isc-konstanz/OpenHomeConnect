...
public enum Resource {
	...
	FREEZER_SETPOINT_TEMPERATURE(Type.SETTINGS, Constants.SETTINGS_FREEZER_SETPOINT_TEMPERATURE,
    		HomeConnectApiClient.VALUE_TYPE_INT),
    FRIDGE_SETPOINT_TEMPERATURE(Type.SETTINGS, Constants.SETTINGS_FRIDGE_SETPOINT_TEMPERATURE, 
    		HomeConnectApiClient.VALUE_TYPE_INT),
    ...
    //		HomeConnectApiClient.VALUE_TYPE_BOOLEAN),
    FRIDGE_MEASURED_TEMPERATURE(Type.STATUS, Constants.FRIDGE_MEASURED_TEMPERATURE, 
    	    		HomeConnectApiClient.VALUE_TYPE_DOUBLE),
    FREEZER_MEASURED_TEMPERATURE(Type.STATUS, Constants.FREEZER_MEASURED_TEMPERATURE, 
    		HomeConnectApiClient.VALUE_TYPE_DOUBLE),
	
    WASHER_ACTIVE_PROGRAM(Type.PROGRAM_ACTIVE, Constants.ACTIVE_PROGRAM, 
    		HomeConnectApiClient.VALUE_TYPE_STRING),
    WASHER_OPERATION_STATE(Type.STATUS, Constants.STATUS_OPERATION_STATE, 
    		HomeConnectApiClient.VALUE_TYPE_STRING),
    WASHER_PROGRAM_PROGRESS(Type.PROGRAM_ACTIVE_OPTIONS, Constants.OPTION_TOTAL_PROGRAM_PROGRESS, 
    		HomeConnectApiClient.VALUE_TYPE_INT),
	WASHER_SELECTED_PROGRAM(Type.PROGRAM_SELECTED, Constants.SELECTED_PROGRAM, 
			HomeConnectApiClient.VALUE_TYPE_STRING),
	...
	DISHWASHER_ACTIVE_PROGRAM(Type.PROGRAM_ACTIVE, Constants.ACTIVE_PROGRAM, 
    		HomeConnectApiClient.VALUE_TYPE_STRING),
	DISHWASHER_OPERATION_STATE(Type.STATUS, Constants.STATUS_OPERATION_STATE, 
    		HomeConnectApiClient.VALUE_TYPE_STRING),
	DISHWASHER_PROGRAM_PROGRESS(Type.PROGRAM_ACTIVE_OPTIONS, Constants.OPTION_TOTAL_PROGRAM_PROGRESS, 
    		HomeConnectApiClient.VALUE_TYPE_STRING),
	DISHWASHER_SELECTED_PROGRAM(Type.PROGRAM_SELECTED, Constants.SELECTED_PROGRAM, 
			HomeConnectApiClient.VALUE_TYPE_STRING),
